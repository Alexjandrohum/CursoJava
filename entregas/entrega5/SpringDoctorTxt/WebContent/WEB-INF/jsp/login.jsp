...
<body>
	<div class="container p-4 ">
		<div class="row justify-content-md-center col align-self-center">
			<form:form method="post" modelAttribute="credenciales"
				...
				<br />
				<br />
				<a href="http://localhost:8081/SpringDoctorTxt/formulario"
					style="color: white; text-align: center">Registrarse</a>
			</form:form>
		</div>
	</div>
</body>
