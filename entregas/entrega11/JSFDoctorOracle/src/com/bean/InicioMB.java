...
public class InicioMB {
	...
	public String crearHorario() {
		HorarioContent horario = new HorarioContent(semana, diaLunes, inicioL, terminoL, diaMartes, inicioM, terminoM,
				diaMiercoles, inicioMie, terminoMie, diaJueves, inicioJ, terminoJ, diaviernes, inicioV, terminoV);
		HorarioService service = new HorarioDao();

		HorarioService service2 = new HorarioDao();
		System.out.println("Docst: " + service2.getDoctoresFilter("l"));
