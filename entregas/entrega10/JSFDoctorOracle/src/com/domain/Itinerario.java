...
public class Itinerario {
	...
	public Itinerario(int idItinerario, int noSemana, int inicioL, int terminoL, String diaLunes, int inicioM,
	...
	public String toString() {
		return "Itinerario [idItinerario=" + idItinerario + ", noSemana=" + noSemana + ", inicioL=" + inicioL
